 ...
 */
public class CPP14ParserInfoListener implements CPP14ParserListener {
	/**
	 * {@inheritDoc}
	 *
	 ...
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void enterJBreak(CPP14Parser.JBreakContext ctx) { }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void exitJBreak(CPP14Parser.JBreakContext ctx) { }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void enterJContinue(CPP14Parser.JContinueContext ctx) { }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void exitJContinue(CPP14Parser.JContinueContext ctx) { }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void enterJReturn1(CPP14Parser.JReturn1Context ctx) { }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation does nothing.</p>
	 */
        @Override public void exitJReturn1(CPP14Parser.JReturn1Context ctx) {
          if (ctx.bracedInitList() != null) {
            System.out.println("<RETURN_BRACELIST>$$BEGIN:" + Integer.toString(ctx.Return().getSymbol().getStartIndex()) + "$$END:" + Integer.toString(ctx.Semi().getSymbol().getStopIndex()));
          } else if (ctx.expression() != null) {
            System.out.println("<RETURN_EXPR>$$BEGIN:" + Integer.toString(ctx.Return().getSymbol().getStartIndex()) + "$$END:" + Integer.toString(ctx.Semi().getSymbol().getStopIndex()) + "$$EXPRBEGIN:" + Integer.toString(ctx.expression().getStart().getStartIndex()) + "$$EXPREND:" + Integer.toString(ctx.expression().getStop().getStopIndex()));
          } else {
            System.out.println("<RETURN_VOID>$$BEGIN:" + Integer.toString(ctx.Return().getSymbol().getStartIndex()) + "$$END:" + Integer.toString(ctx.Semi().getSymbol().getStopIndex()));
          }
        }
	/**
	 * {@inheritDoc}
	 ...
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void enterJGoto(CPP14Parser.JGotoContext ctx) { }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void exitJGoto(CPP14Parser.JGotoContext ctx) { }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation does nothing.</p>
	 ...
	 */
        @Override public void exitFunctionDefinition(CPP14Parser.FunctionDefinitionContext ctx) {
          ...
          if (ctx.attributeSpecifierSeq(0) != null) {
            System.out.println("<FunctionDefinition>$$DECLARATOR_START:" + Integer.toString(ctx.declarator().getStart().getStartIndex()) + "$$DECLARATOR_STOP:" + Integer.toString(ctx.declarator().getStop().getStopIndex()) + "$$BODY_START:" + Integer.toString(ctx.functionBody().getStart().getStartIndex()) + "$$BODY_STOP:" + Integer.toString(ctx.functionBody().getStop().getStopIndex()) + "$$ATTR_START:" + Integer.toString(ctx.attributeSpecifierSeq(0).getStart().getStartIndex()) + "$$BAN:" + Integer.toString(ban));
          } else if (ctx.declSpecifierSeq() != null) {
            System.out.println("<FunctionDefinition>$$DECLARATOR_START:" + Integer.toString(ctx.declarator().getStart().getStartIndex()) + "$$DECLARATOR_STOP:" + Integer.toString(ctx.declarator().getStop().getStopIndex()) + "$$BODY_START:" + Integer.toString(ctx.functionBody().getStart().getStartIndex()) + "$$BODY_STOP:" + Integer.toString(ctx.functionBody().getStop().getStopIndex()) + "$$DECL_START:" + Integer.toString(ctx.declSpecifierSeq().getStart().getStartIndex()) + "$$BAN:" + Integer.toString(ban));
          } else {
            System.out.println("<FunctionDefinition>$$DECLARATOR_START:" + Integer.toString(ctx.declarator().getStart().getStartIndex()) + "$$DECLARATOR_STOP:" + Integer.toString(ctx.declarator().getStop().getStopIndex()) + "$$BODY_START:" + Integer.toString(ctx.functionBody().getStart().getStartIndex()) + "$$BODY_STOP:" + Integer.toString(ctx.functionBody().getStop().getStopIndex()) + "$$BAN:" + Integer.toString(ban));
          }
        }
	/**
	 * {@inheritDoc}
	 ...
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void enterFuncBody1(CPP14Parser.FuncBody1Context ctx) { }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation does nothing.</p>
	 */
        @Override public void exitFuncBody1(CPP14Parser.FuncBody1Context ctx) {
          if (ctx.constructorInitializer() == null) {
            System.out.println("<FunctionBody>$$LEFT_BRACE:" + Integer.toString(ctx.compoundStatement().LeftBrace().getSymbol().getStartIndex()) + "$$RIGHT_BRACE:" + Integer.toString(ctx.compoundStatement().RightBrace().getSymbol().getStartIndex()));
          }
        }
	/**
	 * {@inheritDoc}
	 ...
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void enterFuncBody2(CPP14Parser.FuncBody2Context ctx) { }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void exitFuncBody2(CPP14Parser.FuncBody2Context ctx) {
          System.out.println("<FunctionBody>$$LEFT_BRACE:" + Integer.toString(ctx.functionTryBlock().compoundStatement().LeftBrace().getSymbol().getStartIndex()) + "$$RIGHT_BRACE:" + Integer.toString(ctx.functionTryBlock().compoundStatement().RightBrace().getSymbol().getStartIndex()));
        }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void enterFuncBody3(CPP14Parser.FuncBody3Context ctx) { }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void exitFuncBody3(CPP14Parser.FuncBody3Context ctx) { }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation does nothing.</p>
