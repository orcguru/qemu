...
sub UpdateFunc
{
  ...
  $funcStr = $splits[0].", XMM_PARAM_DECLARE$additional_params";
  ...
  if ($var eq "") {
    $funcStr =~ s/}\s*$/return FUNC_RET(rax, rcx, rdx, rbx, rsp, rbp, rsi, rdi, r8, r9, r10, r11, r12, r13, r14, r15, src, dst, op, rip, XMM_PARAM_LIST);\n}/;
  } else {
    $funcStr =~ s/}\s*$/return FUNC_RET(rax, rcx, rdx, rbx, rsp, rbp, rsi, rdi, r8, r9, r10, r11, r12, r13, r14, r15, src, dst, op, rip, XMM_PARAM_LIST, $var);\n}/;
  }

  if ($var eq "") {
    $out = $out."extern __attribute__((qemuaot)) void FUNC_RET(unsigned long rax, unsigned long rcx, unsigned long rdx, unsigned long rbx, unsigned long rsp, unsigned long rbp, unsigned long rsi, unsigned long rdi, unsigned long r8, unsigned long r9, unsigned long r10, unsigned long r11, unsigned long r12, unsigned long r13, unsigned long r14, unsigned long r15, unsigned long cc_src, unsigned long cc_dst, unsigned int cc_op, unsigned long rip, XMM_PARAM_DECLARE_COMMON);\n";
  } else {
    $out = $out."extern __attribute__((qemuaot)) void FUNC_RET(unsigned long rax, unsigned long rcx, unsigned long rdx, unsigned long rbx, unsigned long rsp, unsigned long rbp, unsigned long rsi, unsigned long rdi, unsigned long r8, unsigned long r9, unsigned long r10, unsigned long r11, unsigned long r12, unsigned long r13, unsigned long r14, unsigned long r15, unsigned long cc_src, unsigned long cc_dst, unsigned int cc_op, unsigned long rip, XMM_PARAM_DECLARE_COMMON, $type $var);\n";
  }
