...
uint8_t opciosz[OPCODE_MAX][3] = {
    [add_i64] = {64, 64, 64},
    [andc_i64] = {64, 64, 64},
    [and_i64] = {64, 64, 64},
    // high 32bits ignored
    [bswap32_i64] = {64, 32, 64},
    [clz_i64] = {64, 64, 64},
    [ctz_i64] = {64, 64, 64},
    [deposit_i32] = {32, 32, 32},
    [deposit_i64] = {64, 64, 64},
    [extract2_i64] = {64, 64, 64},
    [extract_i32] = {32, 32, 32},
    [extract_i64] = {64, 64, 64},
    [extrl_i64_i32] = {64, 32, 32},
    [extu_i32_i64] = {32, 32, 64},
    [ld32s_i64] = {0, 0, 64},
    [ld32u_i64] = {0, 0, 64},
    [ld8u_i64] = {0, 0, 64},
    [ld_i32] = {0, 0, 32},
    [ld_i64] = {0, 0, 64},
    [movcond_i32] = {32, 32, 32},
    [movcond_i64] = {64, 64, 64},
    [mov_i32] = {32, 32, 32},
    [mov_i64] = {64, 64, 64},
    [mov_i64_const] = {0, 0, 64},
    [mul_i32] = {32, 32, 32},
    [mul_i64] = {64, 64, 64},
    [mulsh_i64] = {64, 64, 64},
    [muluh_i64] = {64, 64, 64},
    [neg_i32] = {32, 32, 32},
    [neg_i64] = {64, 64, 64},
    [negsetcond_i64] = {64, 64, 64},
    [not_i64] = {64, 64, 64},
    [or_i64] = {64, 64, 64},
    [push_ret_addr] = {64, 64, 64},
    [qemu_ld2_i128] = {0, 0, 64},
    [qemu_ld_i32] = {0, 0, 32},
    [qemu_ld_i64] = {0, 0, 64},
    [qemu_st2_i128] = {64, 0, 0},
    [qemu_st_i32] = {32, 0, 0},
    [qemu_st_i64] = {64, 0, 0},
    [ret] = {64, 64, 64},
    [rotr_i32] = {32, 32, 32},
    [rotr_i64] = {64, 64, 64},
    [sar_i64] = {64, 64, 64},
    [setcond_i64] = {64, 64, 64},
    [sextract_i64] = {64, 64, 64},
    [shl_i64] = {64, 64, 64},
    [shr_i64] = {64, 64, 64},
    [st16_i32] = {32, 16, 0},
    [st16_i64] = {64, 16, 0},
    ...
    [sub_i64] = {64, 64, 64},
    [xor_i64] = {64, 64, 64},
    [bswap64_i64] = {64, 64, 64},
    [brcond_i64] = {64, 64, 64},
    [call_direct] = {64, 64, 64},
    [add_vec] = {128, 128, 128},
    [andc_vec] = {128, 128, 128},
    [and_vec] = {128, 128, 128},
    [cmp_vec] = {128, 128, 128},
    [dupm_vec] = {128, 128, 128},
    [ld_vec] = {128, 128, 128},
    [mov_vec] = {128, 128, 128},
    [or_vec] = {128, 128, 128},
    [shli_vec] = {128, 128, 128},
    [st_vec] = {128, 128, 128},
    [sub_vec] = {128, 128, 128},
    [umax_vec] = {128, 128, 128},
    [umin_vec] = {128, 128, 128},
    [xor_vec] = {128, 128, 128},
};
