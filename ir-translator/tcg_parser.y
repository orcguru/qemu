...
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA slot COMMA slot COMMA slot
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA slot COMMA slot COMMA IMMX
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA slot COMMA slot COMMA slot COMMA slot
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA slot COMMA slot COMMA slot COMMA slot COMMA slot
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA slot COMMA slot COMMA slot COMMA IMMX
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA ENV COMMA IMMX COMMA IMMX
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA ENV COMMA slot COMMA slot COMMA slot COMMA IMMX
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA slot COMMA slot COMMA IMMX COMMA IMMX
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA slot COMMA ENV COMMA slot
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA slot COMMA ENV
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA ENV
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA ENV COMMA slot
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA ENV COMMA slot COMMA slot
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA ENV COMMA slot COMMA IMMX
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA ENV COMMA slot COMMA slot COMMA slot
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA ENV COMMA slot COMMA slot COMMA IMMX
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA ENV COMMA IMMX
| CALL OPCODE COMMA IMMX COMMA IMMD COMMA ENV COMMA IMMX COMMA slot
