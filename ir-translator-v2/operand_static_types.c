...
const LLVMType helper_template_arg_type[HELPER_MAX][MAX_ADDED_ARGS] = {
...
const char *helper_template_arg_name[HELPER_MAX][MAX_ADDED_ARGS] = {
    [helper_cc_compute_all] = {"dst", "src1", "src2", "op"},
    [helper_cc_compute_c] = {"dst", "src1", "src2", "op"},
    [helper_cc_compute_nz] = {"dst", "src1", "op"},
    [helper_palignr_xmm] = {"imm"},
    [helper_dpps_xmm] = {"mask"},
    [helper_pshufhw_xmm] = {"order"},
    [helper_maskmov_xmm] = {"a0"},
    [helper_pclmulqdq_xmm] = {"ctrl"},
    [helper_mpsadbw_xmm] = {"offset"},
    [helper_aeskeygenassist_xmm] = {"ctrl"},
    [helper_blendpd_xmm] = {"imm"},
    [helper_blendps_xmm] = {"imm"},
    [helper_roundpd_xmm] = {"mode"},
    [helper_fma4pd_xmm] = {"flags", "flip"},
    [helper_shufps_xmm] = {"order"},
    [helper_roundps_xmm] = {"mode"},
    [helper_vpmaskmovq_st_xmm] = {"a0"},
    [helper_shufpd_xmm] = {"order"},
    [helper_pblendw_xmm] = {"imm"},
    [helper_fma4ps_xmm] = {"flags", "flip"},
    [helper_vpermilps_imm_xmm] = {"order"},
    [helper_roundsd_xmm] = {"mode"},
    [helper_vpmaskmovd_st_xmm] = {"a0"},
    [helper_pcmpestri_xmm] = {"ctrl"},
    [helper_roundss_xmm] = {"mode"},
    [helper_vpermilpd_imm_xmm] = {"order"},
    [helper_pcmpistri_xmm] = {"ctrl"},
    [helper_dppd_xmm] = {"mask"},
    [helper_vpgatherqq_xmm] = {"a0", "scale"},
    [helper_cvtps2ph_xmm] = {"mode"},
    [helper_vpgatherdd_xmm] = {"a0", "scale"},
    [helper_pcmpestrm_xmm] = {"ctrl"},
    [helper_pcmpistrm_xmm] = {"ctrl"},
    [helper_pshuflw_xmm] = {"order"},
    [helper_pshufd_xmm] = {"order"},
    [helper_vpgatherdq_xmm] = {"a0", "scale"},
    [helper_vpgatherqd_xmm] = {"a0", "scale"},
    [helper_vpgatherqd_ymm] = {"a0", "scale"},
    [helper_pshufd_ymm] = {"order"},
    [helper_roundps_ymm] = {"mode"},
    [helper_pclmulqdq_ymm] = {"ctrl"},
    [helper_vpgatherqq_ymm] = {"a0", "scale"},
    [helper_pshufhw_ymm] = {"order"},
    [helper_vpermq_ymm] = {"order"},
    [helper_vpermilps_imm_ymm] = {"order"},
    [helper_palignr_ymm] = {"imm"},
    [helper_roundpd_ymm] = {"mode"},
    [helper_pshuflw_ymm] = {"order"},
    [helper_fma4pd_ymm] = {"flags", "flip"},
    [helper_fma4ps_ymm] = {"flags", "flip"},
    [helper_dpps_ymm] = {"mask"},
    [helper_cvtps2ph_ymm] = {"mode"},
    [helper_pblendw_ymm] = {"imm"},
    [helper_blendps_ymm] = {"imm"},
    [helper_vpmaskmovq_st_ymm] = {"a0"},
    [helper_vpmaskmovd_st_ymm] = {"a0"},
    [helper_blendpd_ymm] = {"imm"},
    [helper_vpgatherdd_ymm] = {"a0", "scale"},
    [helper_mpsadbw_ymm] = {"offset"},
    [helper_shufps_ymm] = {"order"},
    [helper_shufpd_ymm] = {"order"},
    [helper_vpgatherdq_ymm] = {"a0", "scale"},
    [helper_vpermilpd_imm_ymm] = {"order"},
    [helper_vpermdq_ymm] = {"order"},
    [helper_cvtsq2sd] = {"val"},
    [helper_divq_EAX] = {"t0"},
    [helper_divl_EAX] = {"t0"},
    [helper_idivq_EAX] = {"t0"},
    ...
    [helper_fma4sd] = {"flags"},
    [helper_fma4ss] = {"flags"},
    [helper_sha256rnds2] = {"wk0", "wk1"},
    [helper_cr4_testbit] = {"bit"},
    [helper_divw_AX] = {"t0"},
    [helper_idivb_AL] = {"t0"},
    [helper_idivl_EAX] = {"t0"},
    [helper_idivw_AX] = {"t0"},
    [helper_pdep] = {"src", "mask"},
    [helper_pext] = {"src", "mask"},
    [helper_clrsb_i32] = {"arg"},
    [helper_clrsb_i64] = {"arg"},
    [helper_clz_i32] = {"arg", "zero_val"},
    [helper_clz_i64] = {"arg", "zero_val"},
    [helper_ctpop_i32] = {"arg"},
    [helper_ctpop_i64] = {"arg"},
    [helper_ctz_i32] = {"arg", "zero_val"},
    [helper_ctz_i64] = {"arg", "zero_val"},
    [helper_div_i32] = {"arg1", "arg2"},
    [helper_div_i64] = {"arg1", "arg2"},
    [helper_divu_i32] = {"arg1", "arg2"},
    [helper_divu_i64] = {"arg1", "arg2"},
    [helper_mulsh_i64] = {"arg1", "arg2"},
    [helper_muluh_i64] = {"arg1", "arg2"},
    [helper_rem_i32] = {"arg1", "arg2"},
    [helper_rem_i64] = {"arg1", "arg2"},
    [helper_remu_i32] = {"arg1", "arg2"},
    [helper_remu_i64] = {"arg1", "arg2"},
    [helper_sar_i64] = {"arg1", "arg2"},
    [helper_shl_i64] = {"arg1", "arg2"},
    [helper_shr_i64] = {"arg1", "arg2"},
    [helper_crc32] = {"crc1", "msg", "len"},
    [helper_extrq_i] = {"index", "length"},
    [helper_insertq_i] = {"index", "length"},
};

const char *helper_runtime_arg_name[MAX_ADDED_ARGS] = {
    "arg0", "arg1", "arg2", "arg3", "arg4", "arg5"
};

const char *qemuaot_default_param_name[XREG_MAX + 2 * XMM_COUNT_MAX] = {
    "rax",
    "rcx",
    "rdx",
    "rbx",
...
const char *qemuaot_default_stack_alloca_name[XREG_MAX + 2 * XMM_COUNT_MAX] = {
    "rax.stack",
    "rcx.stack",
    "rdx.stack",
    "rbx.stack",
...
const LLVMType qemuaot_default_param_type[XREG_MAX + 2 * XMM_COUNT_MAX] = {
    [rax] = LLVMInt64,
    [rcx] = LLVMInt64,
    [rdx] = LLVMInt64,
    [rbx] = LLVMInt64,
    ...
    [cc_op] = LLVMInt32,
    [rip] = LLVMInt64,
    LLVMVector2xi64, LLVMVector2xi64,
    LLVMVector2xi64, LLVMVector2xi64,
    LLVMVector2xi64, LLVMVector2xi64,
    LLVMVector2xi64, LLVMVector2xi64,
    LLVMVector2xi64, LLVMVector2xi64,
